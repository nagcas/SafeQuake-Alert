/*
 * Il componente Comprehend visualizza un elenco di post del blog filtrati per la categoria "Comprendere i terremoti".
...
function Comprehend({ posts }) { 
  ...
  return (
    <>
      ...
      <h4 className='text-white content__title__section'>{t('comprehend.title')}</h4>
      <div className='content__category__filter'>
        {/* Filtra e mostra i post appartenenti alla categoria "Comprendere i terremoti" */}
        {posts
          .filter((post) => post.category.includes('Comprendere i terremoti')) // Filtra i post per categoria
