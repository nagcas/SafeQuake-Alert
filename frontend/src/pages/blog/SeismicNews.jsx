/*
 * Il componente SeismicNews visualizza un elenco di post del blog filtrati per la categoria "Notizie sismiche".
...
function SeismicNews({ posts }) {
  ...
  return (
    <>
      ...
      <h4 className='text-white content__title__section'>{t('seismic-news.title')}</h4>
      <div className='content__category__filter'>
        {/* Filtra e mostra i post appartenenti alla categoria "Notizie sismiche" */}
        {posts
          .filter((post) => post.category.includes('Notizie sismiche')) // Filtra i post per categoria
