/*
 * Il componente Technology visualizza un elenco di post del blog filtrati per la categoria "Tecnologia e innovazione".
...
function Technology({ posts }) {
  ...
  return (
    <>
      ...
      <h4 className='text-white content__title__section'>{t('tecnology.title')}</h4>
      <div className='content__category__filter'>
        {/* Filtra e mostra i post appartenenti alla categoria "Tecnologia e innovazione" */}
        {posts
          .filter((post) => post.category.includes('Tecnologia e innovazione')) // Filtra i post per categoria
